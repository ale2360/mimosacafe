    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <hr>
          <p>Acá puedes Administrar los menús de tu Cafeteria, puedes Agregar, Modificar o Eliminar listas de Menús.</p>
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <form id="additemform" method="POST">
		        ...
		        <div class="form-group">
		            <label class="col-form-label">Precio (MXN):</label>
